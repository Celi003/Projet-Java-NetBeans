...
public class utilisateur extends javax.swing.JFrame {
    ...
    public utilisateur() {
     ...
     public void table() {
        String a[] = {"ID", "Id_user", "Nom", "Pass", "Type"};
        rs = db.querySelect(a, "utilisateurs");
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(152, 102, 255));
        ...
        comty.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Type ", "Administracteur", "Employé" }));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(id_user, javax.swing.GroupLayout.DEFAULT_SIZE, 87, Short.MAX_VALUE)
                    .addComponent(nom))
        ...
        jPanel1.add(jPanel2);
        jPanel2.setBounds(10, 310, 500, 99);
        ...
        jPanel1.add(jLabel6);
        jLabel6.setBounds(300, 13, 310, 50);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (id_user.getText().equals("") || nom.getText().equals("") || pass.getText().equals("")
                || comty.getSelectedItem().equals("Type")) {
            JOptionPane.showMessageDialog(this, "SVP entrer les informations complete");
        } else {
            String[] colon = {"Id_user", "Nom", "Pass", "Type"};
            String[] inf = {id_user.getText(), nom.getText(), pass.getText(), comty.getSelectedItem().toString()};
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (txtrech.getText().equals("")) {
            ...
            if (comrech.getSelectedItem().equals("id_user")) {
                rs = db.querySelectAll("utilisateurs", "Id_user LIKE '%" + txtrech.getText() + "%' ");
                tbl_user.setModel(new ResultSetTableModel(rs));
            } else if (comrech.getSelectedItem().equals("Nom")) {
                rs = db.querySelectAll("utilisateurs", "Nom LIKE '%" + txtrech.getText() + "%' ");
                tbl_user.setModel(new ResultSetTableModel(rs));
            } else if (comrech.getSelectedItem().equals("Pass")) {
                rs = db.querySelectAll("utilisateurs", "Pass LIKE '%" + txtrech.getText() + "%' ");
                tbl_user.setModel(new ResultSetTableModel(rs));
            } else if (comrech.getSelectedItem().equals("Type")) {
                rs = db.querySelectAll("utilisateurs", "Type LIKE '%" + txtrech.getText() + "%' ");
                tbl_user.setModel(new ResultSetTableModel(rs));
            }
        } 
