 ...
 */
public class TableUtilisateur extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TableUtilisateur.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
